    ...
    public partial class TablasIniciales : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, new DateTime(2024, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), ".NET" },
                    { 2, true, new DateTime(2024, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Java" },
                    { 3, true, new DateTime(2024, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "AWS" },
                    { 4, true, new DateTime(2024, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Azure" },
                    { 5, true, new DateTime(2024, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Python" }
                });
